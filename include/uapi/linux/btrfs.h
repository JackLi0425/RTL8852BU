...
#ifdef MY_ABC_HERE
#define BTRFS_FEATURE_COMPAT_RO_LOCKER		(1ULL << 59)
#endif /* MY_ABC_HERE */
...
struct btrfs_ioctl_syno_dedupe_cmd_args {
	...
	__u64 offset;		/* in */
	__u64 len;			/* in */
	__u8  action;		/* in, btrfs_ioctl_syno_dedupe_cmd */
};
...
#ifdef MY_DEF_HERE
enum btrfs_syno_cache_protection_state_enum {
	SYNO_CACHE_PROTECTION_STATE_NONE = 0,
	SYNO_CACHE_PROTECTION_STATE_ENABLED,
	SYNO_CACHE_PROTECTION_STATE_ENABLING,
	SYNO_CACHE_PROTECTION_STATE_DISABLING,
	SYNO_CACHE_PROTECTION_STATE_ERROR,
};
#define BTRFS_SYNO_CACHE_PROTECTION_CTL_ENABLE	1
#define BTRFS_SYNO_CACHE_PROTECTION_CTL_DISABLE	2
#define BTRFS_SYNO_CACHE_PROTECTION_CTL_REPLAY	3
#define BTRFS_SYNO_CACHE_PROTECTION_CTL_CLEAR	4
#define BTRFS_SYNO_CACHE_PROTECTION_CTL_STATUS	5
struct btrfs_ioctl_syno_cache_protection_ctl_args {
	__u64 cmd; // commands
	__u32 verbose;
...
#ifdef MY_DEF_HERE
#define BTRFS_IOC_SYNO_CACHE_PROTECTION_CTL	_IOWR(BTRFS_IOCTL_MAGIC, 239, \
				   struct btrfs_ioctl_syno_cache_protection_ctl_args)
#endif /* MY_DEF_HERE */
#ifdef MY_ABC_HERE
