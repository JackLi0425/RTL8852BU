...
*/
		...
		#undef CONFIG_RTW_STATIC_NDEV_NUM
		#endif
	#endif

	#ifndef CONFIG_RTW_STATIC_NDEV_NUM
		#define CONFIG_RTW_STATIC_NDEV_NUM 1
	#endif
#else
	#ifdef CONFIG_RTW_STATIC_NDEV_NUM
	#undef CONFIG_RTW_STATIC_NDEV_NUM
...
#ifndef CONFIG_RTW_STATIC_NDEV_NUM
	#define CONFIG_RTW_STATIC_NDEV_NUM CONFIG_IFACE_NUMBER
#endif

#if !((CONFIG_RTW_STATIC_NDEV_NUM > 0) && \
	(CONFIG_RTW_STATIC_NDEV_NUM <= CONFIG_IFACE_NUMBER))
	#error "CONFIG_RTW_STATIC_NDEV_NUM our of range"
#endif

#if defined(CONFIG_P2P) && defined(CONFIG_SEL_P2P_IFACE) && \
	!((CONFIG_SEL_P2P_IFACE >= 0) && (CONFIG_SEL_P2P_IFACE < CONFIG_RTW_STATIC_NDEV_NUM))
	#error "CONFIG_SEL_P2P_IFACE our of range"
#endif
...
#error "CONFIG_RTW_CFG80211_CAC_EVENT is not supported when enable RTW_PER_ADAPTER_WIPHY"
	...
	#if RTW_P2P_GROUP_INTERFACE
		#error "CONFIG_SEL_P2P_IFACE has no effect when RTW_P2P_GROUP_INTERFACE is enabled"
	#endif
	#ifdef CONFIG_CFG80211_REPORT_PROBE_REQ
		#error "CONFIG_SEL_P2P_IFACE has no effect when CONFIG_CFG80211_REPORT_PROBE_REQ is enabled"
	#endif
#endif
