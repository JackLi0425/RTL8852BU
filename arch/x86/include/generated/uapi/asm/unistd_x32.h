...
#define __NR_syno_utime (__X32_SYSCALL_BIT + 802)
#define __NR_syno_archive_bit (__X32_SYSCALL_BIT + 803)
#define __NR_syno_recv_file (__X32_SYSCALL_BIT + 804)
#define __NR_syno_caseless_stat (__X32_SYSCALL_BIT + 806)
#define __NR_syno_caseless_lstat (__X32_SYSCALL_BIT + 807)
#define __NR_syno_ecrypt_name (__X32_SYSCALL_BIT + 810)
#define __NR_syno_decrypt_name (__X32_SYSCALL_BIT + 811)
#define __NR_syno_acl_check_perm (__X32_SYSCALL_BIT + 812)
#define __NR_syno_acl_is_support (__X32_SYSCALL_BIT + 813)
#define __NR_syno_acl_get_perm (__X32_SYSCALL_BIT + 814)
#define __NR_syno_flush_aggregate (__X32_SYSCALL_BIT + 815)
#define __NR_syno_stat (__X32_SYSCALL_BIT + 819)
#define __NR_syno_fstat (__X32_SYSCALL_BIT + 820)
#define __NR_syno_lstat (__X32_SYSCALL_BIT + 821)
#define __NR_syno_notify_init (__X32_SYSCALL_BIT + 822)
#define __NR_syno_archive_overwrite (__X32_SYSCALL_BIT + 827)
