...
__SYSCALL_COMMON(326, sys_copy_file_range, sys_copy_file_range)
...
__SYSCALL_COMMON(802, sys_syno_utime, sys_syno_utime)
__SYSCALL_COMMON(803, sys_syno_archive_bit, sys_syno_archive_bit)
__SYSCALL_COMMON(804, sys_syno_recv_file, sys_syno_recv_file)
__SYSCALL_COMMON(806, sys_syno_caseless_stat, sys_syno_caseless_stat)
__SYSCALL_COMMON(807, sys_syno_caseless_lstat, sys_syno_caseless_lstat)
__SYSCALL_COMMON(810, sys_syno_ecrypt_name, sys_syno_ecrypt_name)
__SYSCALL_COMMON(811, sys_syno_decrypt_name, sys_syno_decrypt_name)
__SYSCALL_COMMON(812, sys_syno_acl_check_perm, sys_syno_acl_check_perm)
__SYSCALL_COMMON(813, sys_syno_acl_is_support, sys_syno_acl_is_support)
__SYSCALL_COMMON(814, sys_syno_acl_get_perm, sys_syno_acl_get_perm)
__SYSCALL_COMMON(815, sys_syno_flush_aggregate, sys_syno_flush_aggregate)
__SYSCALL_COMMON(819, sys_syno_stat, sys_syno_stat)
__SYSCALL_COMMON(820, sys_syno_fstat, sys_syno_fstat)
__SYSCALL_COMMON(821, sys_syno_lstat, sys_syno_lstat)
__SYSCALL_COMMON(822, sys_syno_notify_init, sys_syno_notify_init)
__SYSCALL_64(823, sys_syno_notify_add_watch, sys_syno_notify_add_watch)
__SYSCALL_64(824, sys_syno_notify_remove_watch, sys_syno_notify_remove_watch)
__SYSCALL_COMMON(827, sys_syno_archive_overwrite, sys_syno_archive_overwrite)
